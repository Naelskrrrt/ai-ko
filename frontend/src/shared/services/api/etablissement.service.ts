...
import type { Etablissement, EtablissementCreate, EtablissementUpdate } from '../../types/etablissement.types';
...
export const etablissementService = {
   ...
   */
  async updateEtablissement(id: string, data: EtablissementUpdate): Promise<Etablissement> {
   ...
   */
  async getByType(type: 'université' | 'école' | 'institut'): Promise<Etablissement[]> {
