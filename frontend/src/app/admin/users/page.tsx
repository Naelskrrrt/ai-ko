...
import type { User, UserCreate, UserUpdate } from "@/shared/types/admin.types";
...
export default function UsersPage() {
  ...
  const handleToggleStatus = async (user: User) => {
    ...
    try {
      ...
      toast({
        title: "❌ Erreur",
        description: error.response?.data?.message || error.message || "Une erreur est survenue lors du changement de statut",
        variant: "error",
      });
    } finally {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Select
              ...
              onChange={(e) => setFilters({ role: e.target.value || null, page: 1 })}
            >
            ...
            <Select
              ...
              onChange={(e) => setFilters({ active: e.target.value || null, page: 1 })}
            >
            ...
            <Select
              ...
              onChange={(e) => setFilters({ per_page: parseInt(e.target.value), page: 1 })}
            >
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {users.map((user) => (
                    <tr key={user.id} className="border-t border-divider hover:bg-default-50">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <Switch
                            ...
                            size="sm"
                            color="success"
                            aria-label={user.emailVerified ? "Désactiver l'utilisateur" : "Activer l'utilisateur"}
                            className={togglingStatus === user.id ? "opacity-50" : ""}
                          />
                      ...
                      <td className="px-4 py-3 text-sm text-default-600">
                        <span title={new Date(user.createdAt).toLocaleString("fr-FR")}>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-end gap-2 relative">
                          {isCurrentUser(user) ? (
                            <Button isIconOnly size="sm" variant="light" isDisabled title="Vous ne pouvez pas modifier votre propre compte">
                            ...
                            <>
                              ...
                              <RoleChangeMenu
                                ...
                                onRoleChange={(newRole) => handleChangeRole(user, newRole)}
                              />
                            </>
                          )}
                        </div>
        ...
        <ModalContent>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <ModalFooter>
              ...
              <Button className="bg-theme-primary text-white hover:bg-theme-primary/90" type="submit" isLoading={isSubmitting}>
      ...
      <ConfirmDialog
        ...
        message={userToDelete ? `Êtes-vous sûr de vouloir supprimer l'utilisateur ${userToDelete.name} ?` : "Êtes-vous sûr de vouloir supprimer cet utilisateur ?"}
