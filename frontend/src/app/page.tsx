  ...
  const features = [
    {
      ...
      description: "Générez automatiquement des questions à choix multiples à partir de vos documents (PDF, DOCX, TXT) grâce à l'intelligence artificielle Hugging Face.",
    ...
    },
    {
      ...
      description: "Correction instantanée des QCM et questions ouvertes avec analyse sémantique avancée utilisant BERT et Sentence-BERT.",
    ...
    },
    {
      ...
      description: "Tableaux de bord détaillés pour enseignants et étudiants avec visualisation des performances et recommandations personnalisées.",
    ...
    },
    {
      ...
      description: "Recevez des retours détaillés sur vos réponses avec des recommandations de révision adaptées à votre niveau.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <div>
                ...
                <div className={subtitle({ class: "text-lg leading-relaxed mt-4" })}>
                  Plateforme intelligente de génération, correction et évaluation automatique 
                  d'exercices pédagogiques. Transformez vos documents en QCM en quelques clics 
                  grâce à l'IA Hugging Face.
                </div>
              </div>
        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          >
            <h2 className={title({ size: "md", class: "mb-4" })}>
              Pour qui est conçu <span className={title({ color: "secondary" })}>AI-KO</span> ?
            </h2>
            ...
            {[
              {
                ...
                description: "Créez des QCM en quelques minutes, suivez les performances de vos étudiants et obtenez des statistiques détaillées.",
                iconBg: "bg-theme-primary-100 dark:bg-theme-primary-900/30",
                iconColor: "text-theme-primary-600 dark:text-theme-primary-400",
                titleColor: "text-theme-primary-700 dark:text-theme-primary-400"
              },
              {
                ...
                description: "Passez vos examens en ligne, recevez une correction instantanée et des feedbacks personnalisés pour progresser.",
                iconBg: "bg-theme-secondary-100 dark:bg-theme-secondary-900/30",
                iconColor: "text-theme-secondary-600 dark:text-theme-secondary-400",
                titleColor: "text-theme-secondary-700 dark:text-theme-secondary-400"
              },
              {
                ...
                description: "Gérez les utilisateurs, les matières, les niveaux et surveillez l'activité de la plateforme en temps réel.",
                iconBg: "bg-success-100 dark:bg-success-900/30",
                iconColor: "text-success-600 dark:text-success-400",
                titleColor: "text-success-700 dark:text-success-400"
              }
              ...
              >
                <Card className="h-full bg-gradient-to-br from-theme-primary-50 to-theme-secondary-50 dark:from-theme-primary-950/50 dark:to-theme-secondary-950/50 border-2 border-theme-primary-200 dark:border-theme-primary-800/50 hover:shadow-xl transition-all">
                  <CardBody className="p-6 flex flex-col items-center justify-center">
                    <div className={`inline-flex p-4 rounded-full ${item.iconBg} mb-4 w-fit`}>
                      <item.icon className={`w-8 h-8 ${item.iconColor}`} />
                    </div>
                    <h3 className={`text-xl font-semibold ${item.titleColor} mb-3`}>
                      {item.title}
                    </h3>
