...
export function FeedbackPanel({ reponse }: FeedbackPanelProps) {
  ...
  return (
    <Card className={`border-2 ${reponse.est_correcte ? 'border-success-200 bg-success-50/30' : 'border-danger-200 bg-danger-50/30'}`}>
      ...
      <CardBody className="space-y-4 pt-0">
        ...
        <div>
          ...
          <div className={`p-2 rounded-lg ${reponse.est_correcte ? 'bg-success-100/50' : 'bg-danger-100/50'}`}>
        ...
        {reponse.feedback && (
          <div className="flex items-start gap-2 p-3 bg-theme-primary/10 border border-theme-primary/20 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-theme-primary-700">{reponse.feedback}</p>
            </div>
          </div>
        )}
      </CardBody>
